          ...
          {certs.map((cert, i) => (
            ...
            >
              ...
              <div
                ...
                style={{ height: '200px', background: isDark ? '#0d1117' : '#f8f9ff' }}
              >
                <img
                  src={cert.image}
                  alt={cert.title}
              ...
              <div className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-sm font-medium" style={{ color: cert.color }}>
                        {cert.issuer}
                      </p>
                ...
                {/* Bottom bar */}
                <div className={`mt-4 pt-4 flex items-center gap-2 border-t ${
                  isDark ? 'border-white/8' : 'border-gray-100'
                }`}>
                  <FiAward size={14} className={isDark ? 'text-purple-400' : 'text-purple-600'} />
            ...
            >
              ...
              <div className="px-6 py-4 bg-[#111827] flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm" style={{ color: preview.color }}>

          ...
          <div className="space-y-8">
            {education.map((edu, i) => (
              ...
              >
                ...
                >
                  <div className="w-2.5 h-2.5 rounded-full" style={{ backgroundColor: edu.color }} />
                </div>

                {/* Card */}
                <motion.div
                  whileHover={{ x: 8, boxShadow: `0 10px 40px ${edu.color}22` }}
                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p style={{ color: edu.color }} className="font-medium text-sm">
                        {edu.institution}
                      </p>
                    </div>
                  </div>
